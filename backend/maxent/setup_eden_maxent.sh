...
autorun"
   ...
   dir_num=$(eval "printf \"%0${pad}d\" \$i")
	maxent_cmd="java -Xms512m -Xmx512m -XX:-UsePerfData -jar $MAXENT_JAR environmentallayers=$ENV_DIR samplesfile=$samples_dir/${species}.csv outputdirectory=$output_dir/$dir_num $flags"
