...
def separate(input_file):
    ...
    for sp in sorted:
        ...
        if num < 30:
            continue 
        counts_list.append(''.join([sp,' ',str(num),'\n']))
